...
description: "Create custom widgets by describing what you want to the Deepspace agent"
---
...
For tips on getting the best results, see [Tips for working with DeepSpace Agent](/getting-started/ai-tips).
